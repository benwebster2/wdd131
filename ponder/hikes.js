...
let button = DeviceMotionEvent.querySelector('button');
...
function search () {
    ...
    let filterHikes = hikes.filterHikes(function(hike){
        return (
            hikeQuery.name.toLowerCase().includes(hikeQuery.toLowerCase()) ||
